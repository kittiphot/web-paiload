angular.module('myApp').controller('RestaurantsProfileController', ['$scope', 'RestaurantsProfileFactory', '$routeParams', '$window', function ($scope, RestaurantsProfileFactory, $routeParams, $window) {
  ...
  $scope.getRestaurantsProfile = function () {
    RestaurantsProfileFactory.getRestaurantsProfile($scope.id).then(function successCallback(res) {
  ...
  $scope.submit = function () {
    ...
    console.log(params);
    RestaurantsProfileFactory.setRestaurants(params).then(function successCallback(res) {
      console.log(res.data)
